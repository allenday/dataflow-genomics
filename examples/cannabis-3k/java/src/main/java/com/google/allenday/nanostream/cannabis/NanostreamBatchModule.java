 ...
 *
 */
public class NanostreamBatchModule extends BatchProcessingModule {

    public NanostreamBatchModule(String srcBucket,
                                 String inputCsvUri,
    ...
    public static class Builder {
        ...
        public NanostreamBatchModule build() {
            return new NanostreamBatchModule(srcBucket, inputCsvUri, sraSamplesToFilter, sraSamplesToSkip, project, region, genomicsOptions);
        }
