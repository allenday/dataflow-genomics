 ...
 *
 */
public class NanostreamRiceVcfToBqModule extends AbstractModule {
    ...
    public NanostreamRiceVcfToBqModule(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder setFromOptions(NanostreamRicePipelineVcfToBqOptions nanostreamPipelineOptions) {
        ...
        public NanostreamRiceVcfToBqModule build() {
            return new NanostreamRiceVcfToBqModule(this);
        }
