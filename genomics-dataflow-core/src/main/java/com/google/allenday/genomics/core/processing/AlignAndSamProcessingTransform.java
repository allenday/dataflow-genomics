...
/**
 * Contains queue of genomics transformations,
 * namely <a href="https://en.wikipedia.org/wiki/Sequence_alignment">Sequence alignment</a> (FASTQ->SAM),
 ...
 */
public class AlignAndSamProcessingTransform extends PTransform<PCollection<KV<SampleRunMetaData, List<FileWrapper>>>,
        PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, BamWithIndexUris>>>> {
    ...
    @Override
    public PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, BamWithIndexUris>>> expand(
            PCollection<KV<SampleRunMetaData, List<FileWrapper>>> input) {
        PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>> mergedAlignedSequences = input
        ...
        PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>> bamIndexes =
        ...
        return
                KeyedPCollectionTuple.of(mergedAlignedSequencesTag, mergedAlignedSequences)
                        ...
                        .apply("Prepare uris output", MapElements.via(new SimpleFunction<KV<SamRecordsChunkMetadataKey, CoGbkResult>,
                                KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, BamWithIndexUris>>>() {
                            @Override
                            public KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, BamWithIndexUris>> apply(
                                    KV<SamRecordsChunkMetadataKey, CoGbkResult> input) {
    ...
    public static class FinalMergeTransform extends PTransform<PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>>,
            PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>>> {
        ...
        @Override
        public PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>> expand(
                PCollection<KV<SamRecordsChunkMetadataKey, KV<ReferenceDatabaseSource, FileWrapper>>> input) {
            return input.apply(MapElements
                    .into(TypeDescriptors.kvs(TypeDescriptor.of(SamRecordsChunkMetadataKey.class),
