...
public class SamRecordsMetadaKey implements Serializable {

    private SraSampleId sraSampleId;
    private String referenceName;
    private Region region;

    public SamRecordsMetadaKey() {
    }

    public SamRecordsMetadaKey(SraSampleId sraSampleId, String referenceName) {
        this.sraSampleId = sraSampleId;
        this.referenceName = referenceName;
    }

    public SamRecordsMetadaKey(SraSampleId sraSampleId, String referenceName, Region region) {
    ...
    public boolean equals(Object o) {
        ...
        SamRecordsMetadaKey that = (SamRecordsMetadaKey) o;
