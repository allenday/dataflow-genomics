...
public class DeepVariantService {
    ...
    private CloudLifeSciences buildCloudLifeSciences() throws IOException {
        ...
        if (credential.createScopedRequired()) {
            credential = credential.createScoped(Collections.singletonList(DEEP_VARIANT_CREDENTIAL_SCOPE));
        }
        return new CloudLifeSciences(httpTransport, jsonFactory, credential);
    }

    public Triplet<String, Boolean, String> processExampleWithDeepVariant(String outDirGcsUri, String outFilePrefix, String bamUri, String baiUri, ReferenceDatabase referenceDatabase) {
    ...
    private List<String> buildCommand(String outDirGcsUri, String outfileGcsUri, String bamUri, String baiUri,
        ...
        args.put(DeepVariantArguments.STAGING, outfileGcsUri);
        args.put(DeepVariantArguments.OUTFILE, outDirGcsUri + DEEP_VARIANT_STAGING_DIR_NAME);
        args.put(DeepVariantArguments.BAM, bamUri);
        args.put(DeepVariantArguments.BAI, bamUri);
